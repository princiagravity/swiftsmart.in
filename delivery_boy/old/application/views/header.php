  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Logo Wrapper-->
        <div class="logo-wrapper"><a href="home.html"><img src="<?php echo base_url()?>img/core-img/logo-small.png" alt=""></a></div>
        <!-- Search Form-->
    ...
    <div class="suha-sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        <div class="user-profile"><img src="<?php echo base_url()?>img/bg-img/9.jpg" alt=""></div>
        <div class="user-info">
          <h6 class="user-name mb-0">Gravity</h6>
