...
{
    ?>
<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/store_update/<?php echo $s['store_id'];?>">
<div class="card-body-table">
<div class="news-content-right pd-20">
<div class="form-group">
<label class="form-label">Store Name*</label>
<input type="text" name="store_name" class="form-control" value="<?php echo $s['store_name'];?>">
</div>
<!-- <div class="form-group">
...
<input class="save-btn hover-btn" type="submit" value="Update Store"/>
</div>
</div>
</form>
<?php } ?>
