...
<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/Admin_ctlr/offer_list">Offer</a></li>
...
<?php foreach($offer as $o)
{
    ?>

<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/offer_update/<?php echo $o['offer_id'];?>">
<div class="card-body-table">
<div class="news-content-right pd-20">
<div class="form-group">
<label class="form-label">Title*</label>
<input type="text" name="offer_title" class="form-control" value="<?php echo $o['offer_title'];?>">
</div>
<div class="form-group">
<label class="form-label">Offer Image*(Size Width 580 , Height 300)</label>
<div class="file">
										<div class="option-group">
											
											<input type="file" class="custom-file fileupload1" name="filename">
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="offer_image" value="<?php echo $o['offer_image'];?>">
...
<textarea class="text-control" name="offer_desc" placeholder="Enter Description"><?php echo $o['offer_description'];?></textarea>
</div>
</div>
</div>
...
<input class="save-btn hover-btn" type="submit" value="Update Offer"/>
</div>
</div>
</form>
<?php } ?>
...
<script type="text/javascript">
    ...
    $('.fileupload1').fileupload({
          url: "<?php echo base_url();?>admin/img_upload_ctrl/upload_offer_img",
          dataType: 'json', 
