...
<h2 class="mt-30 page-title">Price List</h2>
...
<div class="col-lg-12">
<a href="<?php echo base_url();?>admin/Admin_ctlr/price_add" class="add-btn hover-btn">Add New</a>
</div>
...
<a href="<?php echo base_url();?>admin/Admin_ctlr/price_edit/<?php echo $item['price_id'];?>" class="edit-btn"><i class="fas fa-edit"></i></a>
<a href="<?php echo base_url();?>admin/Admin_ctlr/price_delete/<?php echo $item['price_id']; ?>" class="edit-btn"><i class="fas fa-trash"></i> </a>
