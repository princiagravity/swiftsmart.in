...
<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/slider_insert">
...
<div class="file">
										<div class="option-group">
											...
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="slider_image" >
...
<input type="text" name="slider_subtitle" class="form-control" placeholder="Slider Sub Title">
</div>
<input class="save-btn hover-btn" type="submit" value="Add New Slider"/>
</div>
</div>
</form>
</div>
