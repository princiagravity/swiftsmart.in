...
<li class="breadcrumb-item active">Edit Avertisement</li>
</ol>
<div class="row">
<div class="col-lg-6 col-md-6">
<div class="card card-static-2 mb-30">
<div class="card-title-2">
<h4>Edit Avertisement</h4>
</div>
<?php foreach($advertisement as $s)
{?>
<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/advertisement_update/<?php echo $s['adv_id'];?>">
<div class="card-body-table">
<div class="news-content-right pd-20">
<div class="form-group">
<label class="form-label">Title*</label>
<input type="text" name="adv_title" class="form-control" value="<?php echo $s['adv_title'];?>">
</div>
<div class="form-group">
...
<div class="file">
										<div class="option-group">
											...
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="adv_photo" value="<?php echo $s['adv_photo'];?>">
...
<input class="save-btn hover-btn" type="submit" value="Update Avertisement"/>
</div>
</div>
</form>
<?php } ?>
