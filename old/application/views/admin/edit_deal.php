...
<?php foreach($deal as $o)
{
    ?>

<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/deal_update/<?php echo $o['deal_id'];?>">
<div class="card-body-table">
<div class="news-content-right pd-20">
<div class="form-group">
<label class="form-label">Title*</label>
<input type="text" name="deal_title" class="form-control" value="<?php echo $o['deal_title'];?>">
</div>
<div class="form-group">
...
<div class="file">
										<div class="option-group">
											...
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="deal_image" value="<?php echo $o['deal_image'];?>">
...
<textarea class="text-control" name="deal_desc" placeholder="Enter Description"><?php echo $o['deal_description'];?></textarea>
</div>
</div>
</div>
...
<input class="save-btn hover-btn" type="submit" value="Update Deal"/>
</div>
</div>
</form>
<?php } ?>
