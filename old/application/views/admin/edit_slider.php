...
<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/Admin_ctlr/slider_list">Slider</a></li>
...
{?>
<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/slider_update/<?php echo $s['slider_id'];?>">
<div class="card-body-table">
<div class="news-content-right pd-20">
<div class="form-group">
<label class="form-label">Title*</label>
<input type="text" name="slider_title" class="form-control" value="<?php echo $s['slider_title'];?>">
</div>
<div class="form-group">
<label class="form-label">Slider Image*(Size Width 1200 , Height 550)</label>
<div class="file">
										<div class="option-group">
											
											<input type="file" class="custom-file fileupload1" name="filename">
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="slider_image" value="<?php echo $s['slider_image'];?>">
...
<input type="text" name="slider_subtitle" class="form-control" value="<?php echo $s['slider_subtitle'];?>">
</div>
<input class="save-btn hover-btn" type="submit" value="Update Slider"/>
</div>
</div>
</form>
<?php } ?>
