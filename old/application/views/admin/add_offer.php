...
<form method="post" action="<?php echo base_url();?>admin/Admin_ctlr/offer_insert">
...
<div class="file">
										<div class="option-group">
											...
											<input type="text" class="form-control filename2" id="uploader" placeholder="no file selected" readonly="" name="offer_image" >
...
<textarea class="text-control" name="offer_desc" placeholder="Enter Description"></textarea>
</div>
</div>
</div>
...
<input class="save-btn hover-btn" type="submit" value="Add New Offer"/>
</div>
</div>
</form>
</div>
