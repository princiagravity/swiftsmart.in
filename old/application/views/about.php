    ...
    <div class="page-contain about-us">
        ...
        <div id="main-content" class="main-content">
            ...
            <div class="welcome-us-block">
                <div class="container">
                    <h4 class="title">Welcome to Santhwanam!</h4>
                    <div class="text-wraper">
                        <p class="text-info">Santhwanam is established as the Social Apostolate Centre of Trichur, Archdiocese, under Canon Law vide the Decree No. 435/02-02-2010 by His Grace Mar Andrews Thazhath, with the main objects of coordination, control, consolidate, execute and guide social service activities s of different Charity institutions, congregations and different ministries under the control of Archdiocese. </p>
                        <b>Vision</b>
                        <p class="qt-text">“Spread the divine message of love and peace among humanity for its social uplift and enrichment. ”</p>
                        <b>Mission</b>
                        <p class="qt-text">“Promote coordination and creative action of different social institutions, congregations and Archdiocesan ministries to achieve sustainability and growth in society.”</p>
                ...
                <div class="container">
                    ...
                    <div class="showcase">
                        ...
                        <div class="sc-child sc-center-position">
                            <figure><img src="<?php echo base_url();?>public_html/assets/images/about-us/bn04.jpg" alt="" width="622" height="656"></figure>
                        </div>
            ...
            <!--                    <div class="avata">-->
            <!--                        <figure><img src="<?php echo base_url();?>public_html/assets/images/about-us/author-01.png" alt="" width="217" height="217"></figure>-->
            <!--                    </div>-->
            ...
            <!--                <div class="testml-elem">-->
            <!--                    <div class="avata">-->
            <!--                        <figure><img src="<?php echo base_url();?>public_html/assets/images/about-us/author-02.png" alt="" width="217" height="217"></figure>-->
            <!--                    </div>-->
            <!--                    <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.</p>-->
            ...
            <!--                <div class="testml-elem">-->
            <!--                    <div class="avata">-->
            <!--                        <figure><img src="<?php echo base_url();?>public_html/assets/images/about-us/author-03.png" alt="" width="217" height="217"></figure>-->
            <!--                    </div>-->
            <!--                    <p class="desc">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.</p>-->
