...
<link rel="icon" type="image/png" href="<?php echo base_url(); ?>public_html/img/logo.svg">
...
<!--search-->
<!-- <div class="list-unstyled form-inline mb-0 ml-auto" style="margin-top:3%">
...
<ul id="searchResultt" class="list-group" style="position:absolute;margin-top: 19%;
    z-index: 999;
   float:left"></ul>
...
<ul id="searchResult" class="list-group" style="position:absolute;margin-top: 19%;
    z-index: 999;
    width: 20%;"></ul>
